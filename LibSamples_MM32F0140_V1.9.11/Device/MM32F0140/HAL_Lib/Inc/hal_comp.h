...
////////////////////////////////////////////////////////////////////////////////
/// @brief COMP_AnalogOutput
////////////////////////////////////////////////////////////////////////////////
typedef enum {
    COMP_AnalogOutput_Sync              = 0x00000000,                           ///< Analog signal output after synchronization
    COMP_AnalogOutput                   = COMP_CSR_OSEL1,                       ///< Analog signal direct output 
} EM_COMP_AnalogOutput;
...
typedef struct {
    ...
    union {
        u32 COMP_OutAnaSel;
        u32 OutAnaSel;                                                          ///< Selects the output source of the comparator.
    };
    union {
        u32 COMP_Filter;
